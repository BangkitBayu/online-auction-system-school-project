...
class AuctionController extends Controller
{
    ...
    {
        $auction = Lelang::where('status', '=', 'dibuka')->select(['id_lelang', 'tgl_mulai_lelang', 'tgl_akhir_lelang', 'status', 'id_barang'])->withCount('history_lelangs')->withMax('history_lelangs', 'penawaran_harga')->with('barang:id_barang,nama_barang')->get();
